...
contract dETHV3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("Degen ETH", "dETH") {
    ...
    function adminCreatePair(address _router) public onlyOwner{
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(payable(address(_router))); 
         // Create a uniswap pair for this new token
        dividendTracker.excludeFromDividends(address(_uniswapV2Router));
        // no need for a require as a second call to createPair will revert
